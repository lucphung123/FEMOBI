import{d as B,a as T,aA as L,o as l,m as i,k as e,a3 as N,f as a,t as f,a8 as j,F as A,n as F,h as D,r as x,w as q,as as K,W,br as Z,p as b,i as m,E as z,q as X,e as Q,al as G,j as h,aK as P,v as s,C as O,a7 as H,aC as ee,aN as oe,a5 as se,aM as te,_ as J,ao as le,bs as ne,L as ae,a6 as re,A as ce,J as R,V as ie}from"./entry.b81bf245.js";import{_ as V}from"./DurationDisplay.vue.ebef3eee.js";import{_ as U}from"./Badge.f2e9b29c.js";import{_ as pe}from"./ComposableItem.vue.3f961e9e.js";import{U as ue}from"./json-editor-vue.58ea58a4.js";import{_ as ye}from"./FilepathItem.vue.a967b383.js";import{_ as de}from"./LaunchPage.vue.c2e514b2.js";import{_ as me}from"./NLink.vue.3fcc5a37.js";import{_ as _e}from"./CodeDiff.vue.9b0b0885.js";import{_ as fe}from"./HelpFab.vue.4d768974.js";import"./NMarkdown.vue.e4405095.js";import"./client.d5aff798.js";import"./constants.4e5eba24.js";import"./NCodeBlock.vue.c7ed33b1.js";const ve=B({__name:"TimelineItemFunction",props:{item:{}},setup(v){const u=v,p=T(()=>L(u.item.name,50,60,"_op_")),o=T(()=>p.value.replace(/_op_/,"1")),n=T(()=>L(u.item.name,50,40)),r=T(()=>p.value.replace(/_op_/,"0.2"));return(y,t)=>(l(),i("button",{class:"group",style:N({color:a(o),borderLeft:`2px solid ${a(o)}`}),relative:"","text-sm":"",transition:"","hover:z-1000":"","bg-base":""},[e("div",{style:N({backgroundColor:a(r)}),absolute:"","bottom-0":"","left--1px":"","top-0":"","w-full":"","text-sm":"","transition-all":"","duration-300":""},null,4),e("div",{style:N({color:a(n),"--c":a(o)}),border:"r-2 t-2 y-2 transparent","min-w-max":"",px1:"","text-left":"","group-hover":"border-$c"},f(y.item.name),5)],4))}}),he={relative:"","h-full":""},Ae={absolute:"","left-2":"","top-2.3em":"","text-xs":"",op50:""},De=B({__name:"TimelineSegment",props:{segment:{}},emits:["select"],setup(v,{emit:u}){const p=v,o=j(()=>p.segment.start,{updateInterval:1e3,showSecond:!0,messages:{justNow:"",past:n=>n,future:n=>n,invalid:"-",second:n=>n?`${n}s`:"",minute:n=>`${n}m`,hour:n=>`${n}h`,week:n=>`${n}w`,day:n=>`${n}d`,month:n=>`${n}mo`,year:n=>`${n}y`}});return(n,r)=>{const y=ve;return l(),i("div",he,[e("button",{absolute:"","left-0":"","right-0":"","top-0":"","bg-green:5":"",px2:"",py1:"","text-left":"","text-xs":"","font-mono":"","text-green6":"",onClick:r[0]||(r[0]=t=>n.segment.route?u("select",n.segment.route):void 0)},f(n.segment.route?.event.to),1),e("div",Ae,f(a(o))+" ago ",1),e("div",null,[(l(!0),i(A,null,F(n.segment.functions,(t,c)=>(l(),D(y,{key:c,item:t.event,style:N({position:"absolute",minWidth:`${t.relativeWidth*100}%`,maxWidth:`${t.relativeWidth*100}%`,top:`${4+t.layer*1.6}em`,left:`${t.relativeStart*100}%`}),onClick:d=>u("select",t)},null,8,["item","style","onClick"]))),128))])])}}}),be=3e3,ge=50;function Ce(v){const u=[];let p={start:0,end:0,events:[],functions:[],duration:0};for(const o of v){const n=o.end||o.start;(o.start-p.end>be||o.type==="route")&&(p={start:o.start,end:n,events:[],functions:[],duration:0},u.push(p)),p.events.push(o),p.end=n+ge}return u.forEach((o,n)=>{const r=o.end-o.start,y=[];o.duration=r,o.previousGap=n>0?o.start-u[n-1].end:0,o.events.forEach(t=>{const c=t.end||t.start;let d=0;t.type!=="route"&&(d=y.findIndex(C=>C<=t.start),d===-1?(d=y.length,y.push(c+1e3)):y[d]=c+1e3);const g={event:t,segment:o,relativeStart:(t.start-o.start)/r,relativeWidth:(c-t.start)/r,layer:d};t.type==="function"?o.functions.push(g):o.route=g})}),u}const Ee={relative:""},$e={key:0,border:"x base","h-full":"","flex-inline":"","bg-true-gray-1":"",py15:"","text-xs":"","write-vertical-left":"",op50:"","dark:bg-true-gray-9":""},xe=B({__name:"TimelineTable",props:{data:{}},emits:["select"],setup(v,{emit:u}){const p=v,o=x(),n=x(),r=x(),y=x(),t=x(!0),c=x(1.5),d=T(()=>Ce(p.data.events)),g=T(()=>(p.data.events.length,o.value?.scrollWidth||window.innerWidth));function C(){y.value&&(y.value.style.width=`${g.value}px`)}function I(){t.value&&o.value&&(o.value.scrollTo({left:o.value.scrollWidth-o.value.clientWidth,behavior:"smooth"}),r.value.scrollTo({left:o.value.scrollWidth-o.value.clientWidth,behavior:"smooth"}))}return q(()=>p.data.events.length,async()=>{await K(),C(),I()},{flush:"post"}),W(o,"scroll",()=>{r.value.scrollLeft!==o.value.scrollLeft&&(C(),r.value.scrollLeft=o.value.scrollLeft,t.value=o.value.scrollLeft>=o.value.scrollWidth-o.value.clientWidth)}),W(r,"scroll",()=>{r.value.scrollLeft!==o.value.scrollLeft&&(C(),o.value.scrollLeft=r.value.scrollLeft)}),W(o,"wheel",E=>{E.altKey?(c.value=Z(c.value+E.deltaY/200,.5,3),C()):o.value.scrollLeft+=E.deltaY}),(E,S)=>{const $=V,k=De;return l(),i(A,null,[e("div",Ee,[e("div",{ref_key:"minimap",ref:n,border:"t b base",relative:"","h-50px":"","ws-nowrap":"","border-base":""},[(l(!0),i(A,null,F(a(d),(_,M)=>(l(),i("div",{key:M,relative:"","h-full":"","flex-inline":"",style:N({width:`${Math.max(100,_.duration/10)/a(g)*100}%`})},[(l(!0),i(A,null,F(_.functions,(w,Y)=>(l(),i("div",{key:Y,"h-3px":"",rounded:"",style:N({width:`max(${w.relativeWidth*100}%, 10px)`,position:"absolute",top:`${w.layer*4}px`,left:`${w.relativeStart*100}%`,backgroundColor:("getHashColorFromString"in E?E.getHashColorFromString:a(L))(w.event.name,50,60)})},null,4))),128)),_.route?(l(),i("div",{key:0,absolute:"","top-0":"","h-full":"","w-px":"","border-l":"","border-green6":"",op10:"",style:N({left:`${_.route.relativeStart*100}%`})},null,4)):b("",!0)],4))),128))],512),e("div",{ref_key:"minimapScroller",ref:r,class:"timeline-scroller",absolute:"","inset-0":"","h-full":"","w-full":"","of-x-scroll":""},[e("div",{ref_key:"minimapScrollerInner",ref:y,"h-1px":""},null,512)],512)]),e("div",{ref_key:"scroller",ref:o,relative:"","h-full":"","w-full":"","of-x-scroll":"","of-y-hidden":"","ws-nowrap":"","n-panel-grids":""},[(l(!0),i(A,null,F(a(d),(_,M)=>(l(),i(A,{key:M},[_.previousGap&&_.previousGap>=200?(l(),i("div",$e,[m($,{op50:"",duration:_.previousGap,color:!1},null,8,["duration"])])):b("",!0),m(k,{"flex-inline":"","of-x-hidden":"","hover:of-x-visible":"","bg-base":"",class:z(M===a(d).length-1?"border-r border-base":""),segment:_,style:N({width:`${Math.max(50,_.duration/10)*a(c)}px`}),onSelect:S[0]||(S[0]=w=>u("select",w))},null,8,["class","segment","style"])],64))),128))],512)],64)}}});const Be=X(xe,[["__scopeId","data-v-a2c475c0"]]),ke={border:"t base",flex:"~ col","h-full":"","of-y-auto":"","text-sm":""},we=["onClick"],Te=e("div",{"i-carbon-function":"",op50:""},null,-1),Ne={flex:"~","font-mono":""},Se=e("div",{op30:""}," ( ",-1),Fe={key:0,mr2:"",op30:""},Ie={op75:""},Me=e("div",{op30:""}," ) ",-1),Le=e("div",{"mr-1":"","h-7":"","w-7":"",flex:"","rounded-lg":"","bg-primary:5":"",p1:"","text-green6":""},[e("div",{"i-carbon-direction-rotary-right":"",ma:"","text-lg":""})],-1),Ve={flex:"~ col items-start"},We={"text-xs":"","font-mono":"",op30:""},je={"font-bold":"","font-mono":"","text-green":""},ze=e("div",{"flex-auto":""},null,-1),Oe=e("div",{"min-h-100":""},null,-1),Re=B({__name:"TimelineList",props:{data:{}},emits:["select"],setup(v,{emit:u}){return(p,o)=>{const n=V;return l(),i("div",ke,[(l(!0),i(A,null,F(p.data.events,(r,y)=>(l(),i("button",{key:y,border:"b base",px3:"",py2:"",flex:"~ items-center gap-2",hover:"bg-active",onClick:t=>u("select",r)},[r.type==="function"?(l(),i(A,{key:0},[Te,e("div",{"font-mono":"",style:N({color:r.type==="function"?("getHashColorFromString"in p?p.getHashColorFromString:a(L))(r.name,50,60):""})},f(r.name),5),e("div",Ne,[Se,(l(!0),i(A,null,F(r.args,(t,c)=>(l(),i(A,{key:c},[y?(l(),i("div",Fe," , ")):b("",!0),e("div",Ie,f(t===null?"null":t===void 0?"undefined":typeof t=="function"?"[function]":Array.isArray(t)?"[Array]":typeof t=="object"?"[object]":JSON.stringify(t)),1)],64))),128)),Me])],64)):(l(),i(A,{key:1},[Le,e("div",Ve,[e("div",We,f(r.from),1),e("div",je,f(r.to),1)])],64)),ze,r.end?(l(),D(n,{key:2,duration:r.end-r.start,color:r.type==="function"},null,8,["duration","color"])):b("",!0)],8,we))),128)),Oe])}}}),Ge={key:0,"text-blue":""},Pe={key:1,"text-purple":""},He={key:2,"text-green":""},Je={key:3,"text-gray":""},Ue={key:4,"text-gray":""},Ye={key:5,"text-gray":""},qe={key:0,"bg-red:10":"",px2:"",py1:"","text-red":""},Ke={key:1},Ze={p2:"","text-sm":"",border:"t base"},Xe=B({__name:"TimelineArgumentView",props:{value:{}},setup(v){const u=v,p=x(),o=x();function n(){try{p.value=JSON.parse(JSON.stringify(u.value))}catch(t){console.error(t),o.value=t}}const r=B({emits:["setup"],setup(t,{emit:c}){return c("setup"),()=>null}}),y=Q();return(t,c)=>{const d=O,g=G("VMenu");return typeof t.value=="string"?(l(),i("div",Ge,f(JSON.stringify(t.value)),1)):typeof t.value=="number"?(l(),i("div",Pe,f(t.value),1)):typeof t.value=="boolean"?(l(),i("div",He,f(t.value),1)):typeof t.value>"u"?(l(),i("div",Je," undefined ")):typeof t.value=="function"?(l(),i("div",Ue," [Function"+f(t.value.name?`: ${t.value.name}`:"")+"] ",1)):t.value===null?(l(),i("div",Ye," null ")):(l(),D(g,{key:6,placement:"top"},{popper:h(()=>[m(a(r),{onSetup:n}),a(o)?(l(),i("div",qe," Failed to display object: "+f(a(o)),1)):a(p)?(l(),i("div",Ke,[m(a(ue),P({"model-value":a(p)},t.$attrs,{class:["json-editor-vue",[t.$colorMode.value==="dark"?"jse-theme-dark":""]],"main-menu-bar":!1,"navigation-bar":!1,"status-bar":!1,"read-only":!0,indentation:2,"tab-size":2}),null,16,["model-value","class"]),e("div",Ze,[m(d,{title:"Copy to clipboard",icon:"carbon-copy",onClick:c[0]||(c[0]=C=>a(y)(JSON.stringify(a(p),null,2)))},{default:h(()=>[s(" Copy ")]),_:1})])])):b("",!0)]),default:h(()=>[e("span",{"rounded-sm":"",px1:"","py0.5":"","text-sm":"",class:z([Array.isArray(t.value)?"text-amber bg-amber:10":"text-orange bg-orange:10"])},f(Array.isArray(t.value)?`[Array(${t.value.length})]`:"[Object]"),3)]),_:1}))}}}),Qe={key:0,"p-4":"",flex:"~ col gap-2","text-base":""},eo={"mx--1":""},oo={flex:"~ gap-1","font-mono":""},so={key:1},to=e("span",{ml1:"",op30:""},"(",-1),lo={key:0,op30:""},no=e("span",{op30:""},")",-1),ao={flex:"~ gap-1","text-sm":""},ro=e("span",{mx1:"",op50:""},"·",-1),co={class:"text-sm text-gray-400"},io={key:0,class:"text-xs text-gray-400",mt2:"",grid:"~ cols-[max-content_1fr] gap-x-4","font-mono":""},po={"text-right":""},uo={"ws-nowrap":""},yo=B({__name:"TimelineDetailsFunction",props:{record:{}},setup(v){const u=v,p=H(),o=j(()=>u.record.start,{showSecond:!0});function n(c){let d=new URL(c).pathname;return d.startsWith("/_nuxt/")&&(d=d.slice(6)),d.startsWith("/@id/virtual:nuxt:")?`#build/${d.split("/.nuxt/")[1]}`.replace(/\.m?js$/,""):d.includes("/@fs/")?`/${d.split("/@fs/")[1]}`:(p.value?.rootDir||"")+d}const r=ee(),y=T(()=>r.value?.metadata),t=T(()=>r.value?.imports.find(c=>c.as===u.record.name));return(c,d)=>{const g=U,C=pe,I=Xe,E=V,S=ye;return c.record?(l(),i("div",Qe,[e("div",eo,[m(g,{"bg-yellow-600:10":"","text-yellow-600":"",op75:""},{default:h(()=>[s(" Function call ")]),_:1})]),e("div",oo,[a(t)?(l(),D(C,{key:0,item:a(t),metadata:a(y),counter:!1,classes:"px2 py1","mx--2":""},null,8,["item","metadata"])):(l(),i("span",so,f(c.record.name),1)),to,(l(!0),i(A,null,F(c.record.args,($,k)=>(l(),i(A,{key:k},[k?(l(),i("span",lo,", ")):b("",!0),m(I,{value:$},null,8,["value"])],64))),128)),no]),e("div",ao,[c.record.end?(l(),D(E,{key:0,duration:c.record.end-c.record.start},null,8,["duration"])):b("",!0),ro,e("div",co,f(a(o)),1)]),c.record.stacktrace?(l(),i("div",io,[(l(!0),i(A,null,F(c.record.stacktrace,($,k)=>(l(),i(A,{key:k},[e("div",po,f($.functionName||"(anonymous)"),1),e("div",uo,[$.fileName?(l(),D(S,{key:0,filepath:`${n($.fileName)}:${$.lineNumber}:${$.columnNumber}`,subpath:""},null,8,["filepath"])):b("",!0)])],64))),128))])):b("",!0)])):b("",!0)}}}),mo={key:0,"p-4":"",flex:"~ col gap-2"},_o={"mx--1":""},fo={flex:"~ gap-1 items-center","font-mono":""},vo={op50:""},ho=e("span",{"i-carbon-arrow-right":"",op50:""},null,-1),Ao={flex:"~ gap-1","text-sm":""},Do=e("span",{mx1:"",op50:""},"·",-1),bo={class:"text-sm text-gray-400"},go=B({__name:"TimelineDetailsRoute",props:{record:{}},setup(v){const u=v,p=j(()=>u.record.start,{showSecond:!0});return(o,n)=>{const r=U,y=V;return o.record?(l(),i("div",mo,[e("div",_o,[m(r,{"bg-green-400:10":"","text-green-400":"",op50:""},{default:h(()=>[s(" Route Change ")]),_:1})]),e("div",fo,[e("span",vo,f(o.record.from),1),ho,e("span",null,f(o.record.to),1)]),e("div",Ao,[o.record.end?(l(),D(y,{key:0,duration:o.record.end-o.record.start},null,8,["duration"])):b("",!0),Do,e("div",bo,f(a(p)),1)])])):b("",!0)}}}),Co={relative:"","h-full":"","w-full":"","of-auto":""},Eo={inheritAttrs:!1},$o=B({...Eo,__name:"DrawerBottom",props:{modelValue:{type:Boolean},navbar:{},autoClose:{type:Boolean}},emits:["close"],setup(v,{emit:u}){const p=v,o=x();oe(o,()=>{p.modelValue&&p.autoClose&&u("close")},{ignore:["a","button","summary"]});const n=document.querySelector("#nuxt-devtools-side-nav")?.getBoundingClientRect().width;return(r,y)=>{const t=J;return l(),D(te,{"enter-active-class":"duration-200 ease-in","enter-from-class":"transform translate-y-1/1","enter-to-class":"opacity-100","leave-active-class":"duration-200 ease-out","leave-from-class":"opacity-100","leave-to-class":"transform translate-y-1/1"},{default:h(()=>[r.modelValue?(l(),i("div",P({key:0,ref_key:"el",ref:o,border:"t base",flex:"~ col gap-1",absolute:"","bottom-0":"","right-0":"","z-10":"","z-20":"","of-auto":"","text-sm":"","glass-effect":"",style:{left:`${a(n)}px`}},r.$attrs),[m(t,{absolute:"","right-2":"","top-2":"","z-20":"","text-xl":"",icon:"carbon-close",onClick:y[0]||(y[0]=c=>r.$emit("close"))}),e("div",Co,[se(r.$slots,"default")])],16)):b("",!0)]),_:3})}}}),xo={key:0,"h-screen":"","of-hidden":""},Bo={"h-screen":"","w-full":"",flex:"","flex-col":""},ko={"h-10":"",flex:"~ gap-2 items-center justify-end",p2:"",px3:""},wo={"text-sm":""},To=e("div",{"flex-auto":""},null,-1),No={"min-h-50":"",px3:"",py2:""},So=B({__name:"TimelineView",setup(v){const u=le(),p=x("table"),o=x(),n=T(()=>u.value?.clientTimelineMetrics);function r(){n.value&&(n.value.events=[])}function y(){p.value=p.value==="table"?"list":"table"}return(t,c)=>{const d=G("VTooltip"),g=O,C=J,I=Be,E=Re,S=yo,$=go,k=$o;return a(n)?(l(),i("div",xo,[e("div",Bo,[e("div",ko,[m(d,{flex:""},{popper:h(()=>[e("div",wo,f(a(n).options.enabled?"Recording...":"Paused"),1)]),default:h(()=>[e("div",{"text-lg":"",class:z(a(n).options.enabled?"i-carbon-radio-button-checked text-primary animate-pulse":"i-carbon-pause-outline op30")},null,2)]),_:1}),a(n).options.enabled?(l(),D(g,{key:1,size:"small",ml1:"","text-sm":"",n:"orange",icon:"i-carbon-stop",onClick:c[1]||(c[1]=_=>a(n).options.enabled=!1)},{default:h(()=>[s(" Stop Tracking ")]),_:1})):(l(),D(g,{key:0,size:"small",ml1:"","text-sm":"",n:"primary",icon:"i-carbon-play",onClick:c[0]||(c[0]=_=>a(n).options.enabled=!0)},{default:h(()=>[s(" Start Tracking ")]),_:1})),To,m(C,{icon:a(p)==="table"?"i-carbon-roadmap":"i-carbon-list",class:"ml-2",title:"Toggle View",onClick:y},null,8,["icon"]),m(C,{icon:"i-carbon-trash-can","hover-text-red":"",class:"ml-2",onClick:r})]),a(p)==="table"?(l(),D(I,{key:0,data:{...a(n)},onSelect:c[2]||(c[2]=_=>o.value=_.event)},null,8,["data"])):(l(),D(E,{key:1,data:{...a(n)},onSelect:c[3]||(c[3]=_=>o.value=_)},null,8,["data"]))]),m(k,{"model-value":!!a(o),"auto-close":"",onClose:c[4]||(c[4]=_=>o.value=void 0)},{default:h(()=>[e("div",No,[a(o)?.type==="function"?(l(),D(S,{key:0,record:a(o)},null,8,["record"])):a(o)?.type==="route"?(l(),D($,{key:1,record:a(o)},null,8,["record"])):b("",!0)])]),_:1},8,["model-value"])])):b("",!0)}}}),Fo={class:"markdown-body"},Io=e("h1",null,"Timeline",-1),Mo=e("p",null,[e("blockquote",{"text-orange":"","bg-orange:10":"",py1:""}," This is an experimental feature ")],-1),Lo=e("p",null,"Timeline tracks your route navigations and functions calls in your Nuxt application. It can be used to debug performance issues and to understand how your application works.",-1),Vo=e("h2",null,"Function calls",-1),Wo=e("p",null,[s("Nuxt DevTools tracks function calls by wrapping them in the build time. It works for functions referenced by auto-imports, or explicit imports through "),e("code",null,"import {} from '#imports'"),s(".")],-1),jo=e("pre",null,[e("code",{class:"language-html"},[e("div",{class:"shiki-container"},[e("pre",{class:"shiki vitesse-dark",style:{"background-color":"#121212"},tabindex:"0"},[e("code",{"v-pre":""},[e("span",{class:"line"},[e("span",{style:{color:"#666666"}},"<"),e("span",{style:{color:"#4D9375"}},"script"),e("span",{style:{color:"#DBD7CAEE"}}," "),e("span",{style:{color:"#BD976A"}},"setup"),e("span",{style:{color:"#666666"}},">")]),s(`
...
`),e("span",{class:"line"})])])])])],-1),Ro=[Io,Mo,Lo,Vo,Wo,jo,zo,Oo],Go={__name:"timeline",setup(v,{expose:u}){return u({frontmatter:{}}),(o,n)=>(l(),i("div",Fo,Ro))}},Po={flex:"~ col gap-2","w-150":"",p4:"",border:"t base"},Ho=e("h2",{"text-xl":""},[e("span",{capitalize:""},"Enable Timeline?")],-1),Jo={op50:""},Uo=e("p",null,[e("span",{op50:""},"Then Nuxt will "),e("span",{"text-orange":""},"restart automatically"),s(". ")],-1),Yo={flex:"~ gap-3",mt2:"","justify-end":""},is=B({__name:"timeline",setup(v){const u=ne(),p=H(),o=ae(),n=re();async function r(){const[y,t]=await R.enableTimeline(!0);await o.start(y,t)&&await R.enableTimeline(!1)}return(y,t)=>{const c=So,d=de,g=ce,C=me,I=_e,E=O,S=ie,$=Go,k=fe;return l(),i(A,null,[a(u)?.timeline?.enabled?(l(),D(c,{key:0})):(l(),i(A,{key:1},[m(g,null,{default:h(()=>[m(d,{icon:"i-carbon-roadmap",title:"Timeline",description:"Timeline enables the inspection of when composable being executed and the route changes.",actions:[{label:"Enable"}],onAction:r})]),_:1}),m(a(o),null,{default:h(({resolve:_,args:M})=>[m(S,{"model-value":!0,onClose:w=>_(!1)},{default:h(()=>[e("div",Po,[Ho,e("p",Jo,[s(" Your "),m(C,{role:"button",n:"primary",onClick:t[0]||(t[0]=w=>a(n)(a(p)?._nuxtConfigFile)),textContent:"Nuxt config"}),s(" will be updated as: ")]),m(I,{from:M[0],to:M[1],"max-h-80":"","of-auto":"",py2:"",border:"~ base rounded",lang:"ts"},null,8,["from","to"]),Uo,e("div",Yo,[m(E,{onClick:w=>_(!1)},{default:h(()=>[s(" Cancel ")]),_:2},1032,["onClick"]),m(E,{n:"solid primary",capitalize:"",onClick:w=>_(!0)},{default:h(()=>[s(" Enable ")]),_:2},1032,["onClick"])])])]),_:2},1032,["onClose"])]),_:1})],64)),m(k,null,{default:h(()=>[m($)]),_:1})],64)}}});export{is as default};

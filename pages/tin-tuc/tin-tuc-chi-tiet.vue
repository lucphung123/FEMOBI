<template>
  <div class="w-full">
    ...
    <div class="flex gap-10 items-center border-b pb-15">
      ...
      <div class="w1/2">
        ...
        <div class="flex items-center mt-5 text-md text-color_7">
          ...
          <div class="i-mdi:eye mr-1"></div>
          <div class="text-black mr-3">8649</div>
          <div class="italic text-sm">15 phút đọc</div>
        </div>
      </div>
    </div>
    ...
    <div class="flex text-center items-center gap-2 mt-10">
      <div class="i-mdi:link-variant text-color_4 font-300 text-10"></div>
      <div class="text-color_4 font-bold text-3xl">BÀI VIẾT LIÊN QUAN</div>
    </div>
        ...
        <swiper-slide v-for="(product, index) in products" :key="index">
          <div class="bg-white p-5">
            <div class="items-center flex justify-center">
              <img class="w-40 hover:scale-105 duration-300 rounded-lg" :src="product.imgSrc" alt="" />
            </div>
            <div class="mt-2 text-color_7 text-sm leading-5 gap-2 ml-9 flex items-center">
              <div class="i-mdi:calendar-range"></div>
              {{ product.author }}
            </div>
...
const products = [
  {
    imgSrc: "/img/tintuc/tintuc1.jpg",
    title: "5 trường Đại học đào tạo khoa học máy tính tốt nhất thế giới ",
    author: "28/04/2023",
  },
  {
    imgSrc: "/img/tintuc/tintuc2.png",
    title: "5 trường Đại học đào tạo khoa học máy tính tốt nhất thế giới ",
    author: "28/04/2023",
  },
  {
    imgSrc: "/img/tintuc/tintuc3.jpg",
    title: "5 trường Đại học đào tạo khoa học máy tính tốt nhất thế giới ",
    author: "28/04/2023",
  },
  {
    imgSrc: "/img/tintuc/tintuc4.jpg",
    title: "5 trường Đại học đào tạo khoa học máy tính tốt nhất thế giới ",
    author: "28/04/2023",
  },
  {

<template>
  <NuxtLink
    :to="router_push(props.item_course.slug, props.item_course.id)"
    class="bg-white rounded overflow-hidden shadow-md hover:(!shadow-lg !shadow-blue-400) cursor-pointer duration-300 flex flex-col"
  >
    <img
      class="w-full max-h-40 object-cover"
      preset="cover"
      :src="
        props.item_course.image_url !== ''
          ? props.item_course.image_url
          : '/empty.jpg'
      "
      placeholder="/empty.jpg"
    />

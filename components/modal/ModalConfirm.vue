<template>
  <div class="fixed flex justify-center bg-[#000000da] inset-0 z122" @click="$emit('close-modal')">
    <div @click.stop class="text-center bg-[white] h-40 w-150 mt-50 rounded-[20px]">
      ...
      <div class="mt-5">
        <button class="justify-center bg-color_10 h-11 w-40 text-color_4 text-sm px-[20px] rounded-[20px] font-bold" @click="delete_topic">XÓA CHỦ ĐỀ</button>
        <button class="hover:bg-color_5 hover:text-color_6 justify-center ml-5 bg-color_4 h-11 w-23 text-[white] text-sm px-[20px] rounded-[20px] font-bold" @click="close_modal">HỦY</button>
      </div>
    </div>
